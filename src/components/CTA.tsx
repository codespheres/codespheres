        ...
        <div className="glass-card p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              <Button className="neon-button px-8 py-4 text-lg font-bold flex items-center space-x-2 group">
              ...
              <Button 
                variant="outline"
                className="glass-card border-glass-border hover:border-neon-orange px-8 py-4 text-lg font-semibold text-text-primary hover:text-neon-orange transition-all duration-300"
              >
                Check Availability
              </Button>
            </div>
